...
public class ProcessInstanceServiceTest {
    ...
    public void testQueryProcessInstanceList() {
        ...
        when(processInstanceMapper.queryProcessInstanceListPaging(Mockito.any(Page.class), eq(loginUser.getId()), eq(1), eq(""), eq(-1), Mockito.any(),
        ...
        //executor name empty
        when(processInstanceMapper.queryProcessInstanceListPaging(Mockito.any(Page.class), eq(loginUser.getId()), eq(1), eq(""), eq(0), Mockito.any(),
                eq("192.168.xx.xx"), eq(start), eq(end),"")).thenReturn(pageReturn);
