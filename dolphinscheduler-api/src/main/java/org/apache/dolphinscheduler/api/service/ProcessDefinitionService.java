            ...
            try {
                ...
                try {
                    if (!resources.isEmpty()) {
                        ...
                        ZipMultiPartFile zipMultiPartFile = new ZipMultiPartFile(file.getOriginalFilename().replace(".", DateUtils.getCurrentTime("yyyy_MM_dd_HH_mm_ss") + "."), file.getInputStream());
